...
import { isOwner, isAdmin } from "@/lib/utils/roles";
...
export default function AdminDashboardPage() {
  ...
  const isUserOwner = isOwner(user) || isAdmin(user) || true;

  return (
    <FeatureGuard
      featureKey="dashboard.reports"
      fallbackTitle="Dashboard & Reports"
      isOwner={isUserOwner}
    >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="mt-4 flex items-end justify-between">
              <div>
                <div className="text-2xl font-extrabold text-slate-900 dark:text-white tracking-tight">
                  <AnimatedNumber value={businesses?.length ?? 0} />
                </div>
          ...
          >
            ...
            <div className="mt-4 flex items-end justify-between">
              <div>
                <div className="text-2xl font-extrabold text-slate-900 dark:text-white tracking-tight">
                  <AnimatedNumber value={businesses?.filter((b) => b.status === "active").length ?? 0} />
                </div>
                <div className="text-xs font-medium text-slate-500 dark:text-zinc-400 mt-0.5">
                  Active Companies
                </div>
          ...
          <div className="p-5 rounded-2xl bg-white dark:bg-zinc-900 border border-slate-200/80 dark:border-zinc-800 shadow-sm flex flex-col justify-between">
            ...
            <div className="mt-4 flex items-end justify-between">
              <div>
                <div className="text-2xl font-extrabold text-slate-900 dark:text-white tracking-tight">
                  <AnimatedNumber value={89878.58} prefix="$" decimals={2} />
                </div>
                <div className="text-xs font-medium text-slate-500 dark:text-zinc-400 mt-0.5">
                  Total Earnings
                </div>
            ...
            <div className="mt-6 flex items-end justify-between h-44 px-2">
              {[
                ...
                <div key={idx} className="flex flex-col items-center gap-1.5 flex-1">
                  ...
                  <div
                    className={`w-3.5 rounded-full transition-all duration-300 ${item.badge ? "bg-orange-500" : "bg-[#0e2238] dark:bg-slate-700 hover:bg-slate-700"
                      }`}
              ...
              <div className="space-y-0.5">
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-xl font-extrabold text-slate-900 dark:text-white">
                    <AnimatedNumber value={45787} prefix="$" />
                  </span>
